...
### Interpretation
Words capitalized have meanings defined under the following conditions. The following definitions have the same meaning regardless of whether they appear in singular or in plural.
...
- **Usage Data** refers to data automatically collected, either generated by the use of the Service or from the Service infrastructure itself (for example, the duration of a page visit).
...
We may also collect information that Your browser sends when You visit our Service or access the Service through a mobile device.
